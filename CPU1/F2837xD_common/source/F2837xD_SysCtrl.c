...
void InitSysCtrl(void)
{
    ...
    //CPUSEL는 무조건 각 Peripheral Clock 설정 전에 해준다!!! CPU1은 Default이지만 의미상 레지스터 설정 한다.(0: CPU1, 1: CPU2)
...
//    /*For High Speed Mode*/ this make Peripheral clock to 100Mhz(LSPCLK)...Spi,sci, etc.
